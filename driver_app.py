...
# ==========================================
# TAB 3: ฐานข้อมูล (ฉบับแก้ไขให้บันทึกได้จริง)
# ==========================================
with tab3:
    st.subheader("🗂️ ฐานข้อมูล (ค้นหาและแก้ไข)")
    
    # --- ส่วนตัวกรอง (เหมือนเดิม) ---
    ...
    # --- Logic การกรองข้อมูล ---
    # ใช้ .index เพื่อจำว่าแถวไหนเป็นแถวไหน เวลาแก้จะได้แก้ถูกตัว
    ...
    if not df_to_show.empty:
        ...
        if st.button("💾 บันทึกการแก้ไข", type="primary"):
            try:
                # อัปเดตข้อมูลกลับไปยัง Database หลัก โดยใช้ Index เป็นตัวอ้างอิง
